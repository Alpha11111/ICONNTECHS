			...
			<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img src="<?php bloginfo('template_url');?>/img/product-img1.png" alt="carousel" class="imgh">
					...
					<div class="item">
						<img src="<?php bloginfo('template_url');?>/img/product-img2.png" alt="carousel2" class="imgh">
						<div class="carousel-caption">
							<div id="buy">
					<a>BUY</a>
				</div>
					...
					<div class="item">
						<img src="<?php bloginfo('template_url');?>/img/product-img3.png" alt="carousel3" class="imgh">
						<div class="carousel-caption">
							<div id="buy">
					<a>BUY</a>
				</div>
					...
					<div class="item">
						<img src="<?php bloginfo('template_url');?>/img/product-img4.png" alt="carousel4" class="imgh">
						<div class="carousel-caption">
							<div id="buy">
					<a>BUY</a>
				</div>
